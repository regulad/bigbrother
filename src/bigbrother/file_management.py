...
"""
    File management module from https://github.com/regulad/freebooter/blob/05bca0c9b5523f5215d6c095baaea20d757e578e/src/freebooter/file_management.py
"""
...
class ScratchFile:
    ...
    async def a_initialize_file(self):
        if self._bytes:
            async with aopen(self._path, "wb") as fp:  # type: AsyncBufferedIOBase
                await fp.write(self._bytes)
